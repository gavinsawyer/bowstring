...
const routes: Route[] = [
  {
    data:          {
      description: $localize`:@@apps--Website--Components--Routes--Design--Description:...`,
    },
    ...
    path:          "design",
    pathMatch:     "full",
    title:         $localize`:@@apps--Website--Components--Routes--Design--Title:Design` + ` - ${ title }`,
  },
  {
    data:          {
      description: $localize`:@@apps--Website--Components--Routes--Develop--Description:...`,
    },
    ...
    path:          "develop",
    pathMatch:     "full",
    title:         $localize`:@@apps--Website--Components--Routes--Develop--Title:Develop` + ` - ${ title }`,
  },
  {
    data:          {
      description: $localize`:@@apps--Website--Components--Routes--News--Description:...`,
    },
    ...
    path:          "news",
    pathMatch:     "full",
    title:         $localize`:@@apps--Website--Components--Routes--News--Title:News` + ` - ${ title }`,
  },
  {
    data:          {
