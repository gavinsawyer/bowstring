...
@Component(
  {
    ...
    host:            {
      ...
      "[class.selected]": "segmentedControlValueAccessor?.getOptionIndex(segmentedControlValueAccessor?.value) === segmentedControlValueAccessor?.getOptionIndex(valueInput$())",
    },
    hostDirectives:  [
      {
...
export class SegmentedControlOptionComponent {
  ...
  protected readonly segmentedControlValueAccessor: SegmentedControlValueAccessor | null = inject<SegmentedControlValueAccessor>(
