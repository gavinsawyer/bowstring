...
@Directive(
  {
    ...
    host:     {
      "[style.--standard--well-rounded-directive--brand-roundness]":  "brandRoundness$()",
      "[style.--standard--well-rounded-directive--clip-path-source]": "clipPathSource$()",
      "[style.--standard--well-rounded-directive--level-input]":      "levelInput$()",
    },
    selector: "[standardWellRoundedDirective]",
...
export class WellRoundedDirective {
  ...
  protected readonly clipPathSource$: Signal<`url(#standard--well-rounded-directive--clip-path-${ string })`> = computed<`url(#standard--well-rounded-directive--clip-path-${ string })`>(
    (): `url(#standard--well-rounded-directive--clip-path-${ string })` => `url(#${ this.clipPathId$() })`,
  );
  ...
  public readonly clipPathId$: Signal<`standard--well-rounded-directive--clip-path-${ string }`>                                                                                                                               = signal<`standard--well-rounded-directive--clip-path-${ string }`>(`standard--well-rounded-directive--clip-path-${ uuidV7() }`);
